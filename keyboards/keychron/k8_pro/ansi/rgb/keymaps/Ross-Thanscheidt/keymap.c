...
[NAV] = LAYOUT_tkl_ansi(
     ...
     _______,         KC_LEFT,  KC_UP,    KC_RGHT,  _______,  _______,  _______,  _______, KC_INS,       _______,   _______,      _______,    _______,      _______,  _______,  _______,  _______,
     _______,         KC_HOME,  KC_DOWN,  KC_DEL,   KC_PGDN,  _______,  KC_LEFT,  KC_DOWN, KC_UP,        KC_RGHT,   _______,      _______,                  _______,
