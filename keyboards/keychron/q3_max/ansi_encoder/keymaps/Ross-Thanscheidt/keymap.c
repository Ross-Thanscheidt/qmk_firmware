...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_tkl_ansi(
        ...
        _______,         KC_LEFT,  KC_UP,   KC_RIGHT, _______,  _______, _______, _______, KC_INS,       _______,  _______,      _______,    _______,      _______,  _______,  _______, _______,
        _______,         KC_HOME,  KC_DOWN, KC_DEL,   KC_PGDN,  _______, KC_LEFT, KC_DOWN, KC_UP,        KC_RIGHT, _______,      _______,                  _______,
        _______,                   KC_END,  _______,  _______,  _______, KC_PGUP, _______, _______,      _______,  _______,      _______,                  _______,            _______,
